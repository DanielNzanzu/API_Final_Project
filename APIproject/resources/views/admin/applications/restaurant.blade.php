                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    Application - Restaurant <strong>#{{ $application->ref_number }}</strong>
                                ...
                                <div class="card-header">
                                    <div class="btn-actions-pane-right">
                                        <div role="group" class="btn-group-sm btn-group">
                                            <a href="{{ route('admin.restaurant.application.index') }}" class="active btn btn-primary">All Applications</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-md-6">
                                            <form method="post" action="{{ route('admin.restaurant.application.update', $application->ref_number) }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col col-md-6">
                                                        ...
                                                        <input type="hidden" name="user_update" value="restaurant">

    ...
    <div class="bread-crumbs-wrapper">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Donation #{{ $donation->ref_number }}</li>
            </ol>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-12 col-lg-8 pt-4 mb-0">
                                        <div class="dashboard-title pl-0 mb-3">
                                            <h4 class="title4" itemprop="headline"><span class="sudo-bottom sudo-bg-red">Donation</span> #{{ $donation->ref_number }}</h4>
                                        </div>

                                        <div class="author-info-wrapper mt-0">
                                            <h4 itemprop="headline">About the Donor</h4>
                                            <div class="author-box pb-2 mb-5">
                                                <img class="brd-rd50" src="{{ asset('images/resource/author-img.jpg') }}" alt="author-img.jpg" itemprop="image">
                                                <div class="author-info">
                                                    <h4 itemprop="headline">{{ $donation->user->firstname.' '.$donation->user->lastname }}</h4>
                                                    <p itemprop="description"><i class="fa fa-phone"></i> {{ $donation->user->mobile ? $donation->user->mobile : '' }} <br/>
                                                        <i class="fa fa-envelope"></i> {{ $donation->user->email }}</p>
                                                </div>
                                            </div>
                                            <h4 itemprop="headline">In the basket</h4>
                                            @foreach($donation->order->menus as $menu)
                                            ...
                                            <ul class="ordr-lst brd-rd5 mt-5"><hr class="mb-0">
                                                <li>Subtotal <span>Ksh {{ $donation->order->subtotal }}</span></li>
                                                <li>Delivery <span>Ksh 0.00</span></li>
                                                <li class="lst-hed">Total <span>Ksh {{ $donation->order->total }}</span></li>
                                            </ul>
                                        </div>

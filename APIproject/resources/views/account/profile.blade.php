...
@section('title', 'Dashboard - Profile | CheapFood')
    ...
    <div class="tab-pane fade" id="my-orders">
        <div class="tabs-wrp brd-rd5">
            ...
            <div class="order-list">
                ...
                <div class="order-item brd-rd5">
                    <div class="order-thumb brd-rd5">
                        <a href="#" title="" itemprop="url"><img src="{{ asset('images/resource/order-img2.jpg') }}" alt="order-img2.jpg" itemprop="image"></a>
                ...
                <div class="order-item brd-rd5">
                    <div class="order-thumb brd-rd5">
                        <a href="#" title="" itemprop="url"><img src="{{ asset('images/resource/order-img3.jpg') }}" alt="order-img3.jpg" itemprop="image"></a>
                ...
                <div class="order-item brd-rd5">
                    <div class="order-thumb brd-rd5">
                        <a href="#" title="" itemprop="url"><img src="{{ asset('images/resource/order-img4.jpg') }}" alt="order-img4.jpg" itemprop="image"></a>
    ...
    <div class="tab-pane fade" id="shortlists">
        <div class="tabs-wrp brd-rd5">
            ...
            <div class="restaurants-list">
                ...
                <div class="featured-restaurant-box style3 brd-rd5">
                    <div class="featured-restaurant-thumb"><a href="#" title="" itemprop="url"><img src="{{ asset('images/resource/restaurant-logo1-3.png') }}" alt="restaurant-logo1-3.png" itemprop="image"></a></div>
                    <div class="featured-restaurant-info">
                        <span class="red-clr">5th Avenue New York 68</span>
            ...
            <div class="account-settings-inner">
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="profile-info text-center">
                            <div class="profile-thumb brd-rd50">
                                <img id="profile-display" src="{{ asset('images/resource/profile-img1.jpg') }}" alt="profile-img1.jpg" itemprop="image">
                            </div>
                            <a class="red-clr change-password" href="#" title="" itemprop="url">Change Password</a>
                            <div class="profile-img-upload-btn">
                                <label class="fileContainer brd-rd5 yellow-bg">
                            ...
                            <div class="default-img-lst">
                                <img class="brd-rd50" src="{{ asset('images/resource/profile-thumb1.jpg') }}" alt="profile-thumb1.jpg" itemprop="image">
                                <img class="brd-rd50" src="{{ asset('images/resource/profile-thumb2.jpg') }}" alt="profile-thumb2.jpg" itemprop="image">
                                <img class="brd-rd50" src="{{ asset('images/resource/profile-thumb3.jpg') }}" alt="profile-thumb3.jpg" itemprop="image">
                                <img class="brd-rd50" src="{{ asset('images/resource/profile-thumb4.jpg') }}" alt="profile-thumb4.jpg" itemprop="image">
                                <img class="brd-rd50" src="{{ asset('images/resource/profile-thumb5.jpg') }}" alt="profile-thumb5.jpg" itemprop="image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-8 col-lg-8">
